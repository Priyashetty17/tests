...
func (perq *ProjectsExtendedResourceQuotaTestSuite) TestProjectLevelExtendedResourceQuota() {
	...
	namespaceExtendedQuota := map[string]string{
		"requests.ephemeral-storage": "60Mi",
		"limits.ephemeral-storage":   "120Mi",
	}
	...
	expectedUsage := map[string]string{
		"requests.ephemeral-storage": podEphemeralStorageRequest,
		"limits.ephemeral-storage":   podEphemeralStorageLimit,
	}
	...
	expectedUsage = map[string]string{
		"requests.ephemeral-storage": namespaceapi.InitialUsedResourceQuotaValue,
		"limits.ephemeral-storage":   namespaceapi.InitialUsedResourceQuotaValue,
	}
